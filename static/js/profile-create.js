...
$(document).delegate("#previous-step", "click", function() {
    // Get Current Page
    var page = $(this).data("page");

    // Send User to Previous Step
    if (page == "body") {
        window.location = "/profile/overview";
    }
        ...
        window.location = "/profile/social";
    }
    else if (page == "features") {
        window.location = "/profile/communities";
    }
    else if (page == "confirmation") {
        window.location = "/profile/features";
    }
});
...
$(document).delegate("#next-step", "click", function() {
    ...
    if (page == "overview") {
        ...
        $.post("/profile/save", {
            ...
            if (resp.status === 200) {
                // Redirect User to Next Step
                window.location = "/profile/confirmation";
            }
            else { 
                // Display Error Message
                M.toast({
